...
class Speech2Text:
    ...
    def __init__(
        ...
        task = ASRPERFORMERTask if not enh_s2t_task else EnhS2TTask
...
def inference(
    ...
    loader = ASRPERFORMERTask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=ASRPERFORMERTask.build_preprocess_fn(speech2text.asr_train_args, False),
        collate_fn=ASRPERFORMERTask.build_collate_fn(speech2text.asr_train_args, False),
