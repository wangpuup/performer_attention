...
from espnet2.asr_performer.transformer.attention import MultiHeadedAttention
from espnet2.asr_performer.transformer.decoder_layer import PerformerDecoderLayer
...
class PerformerTransformerDecoder(BaseTransformerDecoder):
    def __init__(
        self,
        vocab_size: int,
        encoder_output_size: int,
        ...
        self.decoders = repeat(
            num_blocks,
            lambda lnum: PerformerDecoderLayer(
                attention_dim,
